...
namespace GRAPE {
    ...
    */
    struct SFI {
        ...
        * @return The thrust specific fuel flow.
        */
        [[nodiscard]] double arrivalFuelFlow(double AltitudeMsl, double TrueAirspeed, double CorrNetThrustPerEng, double MaximumSeaLevelStaticThrust, const Atmosphere& Atm) const noexcept;
    };
}
