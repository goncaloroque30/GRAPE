...
#include "LTOEmissionsGenerator.h"

#include "Base/Atmosphere.h"
#include "Base/Math.h"

namespace GRAPE {
    LTOEmissionsGenerator::LTOEmissionsGenerator(const LTOEngine& LTOEng) {
    ...
    std::tuple<double, double, double> LTOEmissionsGenerator::emissionIndexes(double FuelFlow, double AltitudeMsl, double TrueAirspeed, const Atmosphere& Atm) const {
    ...
    TEST_CASE("BFFM2 Paper") {
        ...
        LTOEmissionsGenerator ltoGen(lto);
