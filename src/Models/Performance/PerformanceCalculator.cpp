...
namespace GRAPE {
    ...
    std::optional<PerformanceOutput> PerformanceCalculator::calculate(const Track4dArrival& Track4dArr) const {
        if (Track4dArr.empty())
        {
    ...
    std::optional<PerformanceOutput> PerformanceCalculator::calculate(const Track4dDeparture& Track4dDep) const {
        if (Track4dDep.empty())
        {
